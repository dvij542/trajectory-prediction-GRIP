...
data_root = '/content/drive/MyDrive/trajectory-prediction-GRIP-current_approach/data/'
...
def generate_data(pra_file_path_list, pra_is_train=True):
	...
	if pra_is_train:
		save_path = '/content/drive/MyDrive/trajectory-prediction-GRIP-current_approach/train_data.pkl'
	else:
